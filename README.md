...
|---|---|---|
| **SYLTRA Adaptive Edge Platform** | `services/`, `libs/`, `apps/`, `simulator/`, `contracts/`, `home-assistant/`, `infrastructure/`, `tests/`, `docs/` | Local-first adaptive smart-home intelligence platform (Python). Governed by `SYLTRA_Claude_Code_Master_Build_Spec.md`. |
...
devices. See `docs/adr/ADR-001-home-assistant-as-replaceable-integration-runtime.md`.
