...
const en: Dictionary = {
  ...
  aboutPage: {
    ...
    values: {
      ...
      items: [
        { name: "One accountability", desc: "A single party owning design, execution and maintenance across every system." },
        { name: "Unified standards", desc: "Quality, documentation and support at the same level in every division." },
        { name: "Integration", desc: "Our systems are designed to talk to each other, not to run apart." },
        { name: "Security", desc: "Privacy and protection are engineered in, never bolted on." },
        { name: "Simplicity", desc: "Power should feel simple." },
        { name: "Trust", desc: "Every system, every time, without exception." },
      ],
    },
    chairman: {
    ...
    facts: [
      { value: "5 divisions", label: "Under one umbrella" },
      { value: "Riyadh", label: "Headquarters" },
      { value: "2030", label: "Aligned with Saudi Vision" },
      { value: "Now", label: "Operating in Saudi Arabia" },
    ],
    roadmap: {
      eyebrow: "Expansion",
