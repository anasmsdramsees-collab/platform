...
export const productCatalog: ProductCategory[] = [
  {
    ...
    items: [
      {
        slug: "hub-mini",
        name: "SYNTRA Hub Mini",
        tags: ["Wi-Fi", "Zigbee", "Z-Wave"],
        en: {
          tagline: "The whole apartment, from one small box.",
          description:
            "Hub Mini brings every room of an apartment or single-floor home onto one system. It's the entry point into the SYNTRA ecosystem — small enough to sit behind a TV, capable enough to run up to 100 devices without missing a beat.",
          specs: [
        ...
        ar: {
          ...
          description:
            "مركز Hub Mini يجمع كل غرف الشقة أو المنزل من طابق واحد في نظام واحد. هو نقطة الدخول لمنظومة سنترا — صغير بما يكفي ليختبئ خلف التلفاز، وقوي بما يكفي لإدارة حتى 100 جهاز دون أي تأخير.",
          specs: [
  ...
  },
  {
    ...
    en: {
      name: "Touch Switches",
      desc: "Glass-front switches that replace the wall switch, not just automate it.",
    },
    ar: {
    ...
    items: [
      {
        slug: "t1", name: "SYNTRA T1", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "t2", name: "SYNTRA T2", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "t3", name: "SYNTRA T3", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "t4", name: "SYNTRA T4", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "td", name: "SYNTRA TD", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "tc", name: "SYNTRA TC", tags: ["Zigbee", "Wi-Fi"],
  ...
  },
  {
    ...
    items: [
      {
        slug: "m1", name: "SYNTRA M1", tags: ["Zigbee", "Z-Wave", "Wi-Fi"],
      ...
      {
        slug: "m2", name: "SYNTRA M2", tags: ["Zigbee", "Z-Wave", "Wi-Fi"],
      ...
      {
        slug: "m3", name: "SYNTRA M3", tags: ["Zigbee", "Z-Wave", "Wi-Fi"],
        en: { tagline: "A whole circuit, made smart at once.", description: "A triple-channel module behind a 3-gang switch — the fastest way to bring an entire room's lighting circuit onto the SYNTRA ecosystem in one retrofit.", specs: [{ label: "Channels", value: "3, independent" }, { label: "Power", value: "100–240V~, 50/60Hz" }, { label: "Max load", value: "3 × 10A" }, { label: "Connectivity", value: "Zigbee 3.0, Wi-Fi 2.4GHz" }] },
        ar: { tagline: "دائرة كاملة، ذكية دفعة واحدة.", description: "وحدة بثلاثة خطوط خلف مفتاح بثلاثة خطوط — أسرع طريقة لإدخال دائرة إضاءة غرفة كاملة إلى منظومة سنترا في عملية ترقية واحدة.", specs: [{ label: "عدد الخطوط", value: "3، مستقلة" }, { label: "الطاقة", value: "100–240V~, 50/60Hz" }, { label: "أقصى حمل", value: "3 × 10 أمبير" }, { label: "الاتصال", value: "Zigbee 3.0، Wi-Fi 2.4GHz" }] },
      },
      {
        slug: "dim", name: "SYNTRA DIM", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "curtain-module", name: "SYNTRA CURTAIN", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "fan", name: "SYNTRA FAN", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "garage", name: "SYNTRA GARAGE", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "air", name: "SYNTRA AIR", tags: ["Wi-Fi", "BLE"],
  ...
  },
  {
    ...
    items: [
      {
        slug: "lock", name: "SYNTRA Lock", tags: ["BLE", "App"],
      ...
      {
        slug: "lock-pro", name: "SYNTRA Pro", tags: ["BLE", "App"],
      ...
      {
        slug: "lock-elite", name: "SYNTRA Elite", tags: ["NFC", "BLE", "App"],
      ...
      {
        slug: "lock-bolt", name: "SYNTRA Bolt", tags: ["BLE", "App"],
      ...
      {
        slug: "cam", name: "SYNTRA Cam", tags: ["Wi-Fi"],
      ...
      {
        slug: "doorbell", name: "SYNTRA Doorbell", tags: ["Wi-Fi"],
  ...
  },
  {
    ...
    items: [
      {
        slug: "motion", name: "SYNTRA Motion Sensor", tags: ["Zigbee"],
      ...
      {
        slug: "door-window", name: "SYNTRA Door / Window Sensor", tags: ["Zigbee"],
        en: { tagline: "Knows the instant it opens.", description: "A slim magnetic contact sensor for doors and windows — instant alerts on opening, and the automation trigger behind countless SYNTRA scenes.", specs: [{ label: "Detection", value: "Magnetic reed contact" }, { label: "Battery life", value: "Up to 2 years" }, { label: "Connectivity", value: "Zigbee 3.0" }] },
        ar: { tagline: "تعرف اللحظة التي يُفتح فيها.", description: "حساس مغناطيسي رفيع للأبواب والنوافذ — تنبيه فوري عند الفتح، وهو المحفّز وراء عدد كبير من مشاهد سنترا.", specs: [{ label: "الكشف", value: "تلامس مغناطيسي" }, { label: "عمر البطارية", value: "حتى سنتين" }, { label: "الاتصال", value: "Zigbee 3.0" }] },
      },
      {
        slug: "climate", name: "SYNTRA Temperature & Humidity Sensor", tags: ["Zigbee"],
      ...
      {
        slug: "light-sensor", name: "SYNTRA Light Sensor", tags: ["Zigbee"],
      ...
      {
        slug: "smoke", name: "SYNTRA Smoke Sensor", tags: ["Zigbee"],
      ...
      {
        slug: "gas", name: "SYNTRA Gas Sensor", tags: ["Zigbee"],
      ...
      {
        slug: "water-leak", name: "SYNTRA Water Leak Sensor", tags: ["Zigbee"],
      ...
      {
        slug: "air-quality", name: "SYNTRA Air Quality Sensor", tags: ["Zigbee", "Wi-Fi"],
  ...
  },
  {
    ...
    items: [
      {
        slug: "thermostat", name: "SYNTRA Thermostat", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "ac-control", name: "SYNTRA AC Control", tags: ["Wi-Fi", "BLE"],
      ...
      {
        slug: "plug", name: "SYNTRA Plug", tags: ["Wi-Fi"],
      ...
      {
        slug: "light", name: "SYNTRA Light", tags: ["Zigbee"],
      ...
      {
        slug: "curtain", name: "SYNTRA Curtain", tags: ["Zigbee", "Wi-Fi"],
      ...
      {
        slug: "robot", name: "SYNTRA Robot", tags: ["Wi-Fi"],
